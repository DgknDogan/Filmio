...
class SeriesHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocBuilder<SeriesHomePageCubit, SeriesHomePageState>(
        builder: (context, state) {
          return SingleChildScrollView(
            child: Column(
              children: [
                RecommendedContainer(
                    imageUrl: state.recommendedSeries?.posterPath!.coverImage ?? "", tag: "series_poster", isLoading: state.isLoading),
